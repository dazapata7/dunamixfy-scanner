...
export function WMSHome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950 p-6">
      {/* Header */}
      <div className="max-w-4xl lg:max-w-[1600px] mx-auto mb-8">
        {/* Back Button */}
        <button
      ...
      {/* Cards Grid */}
      <div className="max-w-4xl lg:max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {cards.map((card) => {
